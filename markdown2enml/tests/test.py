...
class ENMLValidationTest(unittest.TestCase):
    ...
    To avoid network access during testing, I have embedded the evernote
    dtd in this test class. I edited it to make the entities it references
    not be network references. The non existing entity references are then
    silently ignored.
    """

    def setUp(self):
        self.dtd = etree.DTD(self.enml2_dtd())
